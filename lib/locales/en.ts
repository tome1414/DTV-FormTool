const en = {
  ...
  docs: {
    ...
    driverLicense: "Proof of Current Address",
    driverLicense_note: "Please upload a document showing your current address, such as a driver's license, utility bill, or bank statement.",
